...
public class SHARPFIXLocalIndexComponentGenerator implements IndexComponentGenerator
{
    //Index every statement within the method body
	...
	if (md_body_block == null) {
		...
		//return getIndexComponentsForStmtObjList((CompilationUnit)root, md_body_block.statements());
    ...
    private List<IndexComponent> getIndexComponentsForStmt(CompilationUnit cu, Statement stmt) {
       ...
       if (stmt instanceof Block) {
          ...
          //Other statements are not handled
        }
